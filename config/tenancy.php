...
return [
    ...
    'database' => [
        ...
        /**
         * Connection used for the tenant migrations.
         */
     ...
     *
     * Each key in cache will have a tag applied on it. This tag
     * is used to scope the cache both when writing to it and when
     * reading from it.
     */
    'cache' => [
        'tag_base' => 'tenant',
     ...
     * Works for both the local and s3 drivers.
     */
    'filesystem' => [
        /**
    ...
    'redis' => [
        ...
        'prefixed_connections' => [
            // Redis connections to prefix, e.g. 'default'
            'default',
        ],
    ],
