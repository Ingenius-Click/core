...
@section('header')
    <h1>Pago Confirmado - Nueva Factura</h1>
@endsection

@section('content')
    <!-- Main Message -->
    <div class="mb-20">
        <p><strong>Se ha confirmado el pago de una orden y se ha generado la factura.</strong></p>
        <p>A continuación encontrarás los detalles completos de la factura y la orden:</p>
    </div>
